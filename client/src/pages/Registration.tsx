...
import { z } from "zod";
import { Upload, User, Shield, Zap, Target, Swords, Crosshair, HeartPulse } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";
import { Checkbox } from "@/components/ui/checkbox";
import { Form, FormControl, FormField, FormItem, FormLabel, FormMessage } from "@/components/ui/form";
import heroBg from "@assets/generated_images/cyberpunk_esports_tournament_background_with_neon_lights.png";
...
export default function Registration() {
  ...
  return (
    <div className="min-h-screen relative w-full overflow-x-hidden text-white selection:bg-primary/30 pt-20">
      ...
      <div className="container mx-auto px-4 py-12 md:py-24 max-w-5xl relative z-10">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-orbitron font-black uppercase tracking-tight mb-4 text-glow">
            Battle Realm
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12">
            ...
            <section>
              ...
              <GlassCard className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="col-span-1 md:col-span-2">
                      <FormLabel className="text-primary font-bold font-orbitron">Team Name</FormLabel>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-primary font-bold font-orbitron">Team Tag</FormLabel>
                      <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-primary font-bold font-orbitron">Region</FormLabel>
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent className="bg-black/90 border-primary/20 text-white font-rajdhani">
                ...
                <FormField
                  ...
                  render={({ field: { value, onChange, ...fieldProps } }) => (
                    <FormItem className="col-span-1 md:col-span-2">
                      <FormLabel className="text-primary font-bold font-orbitron">Team Logo</FormLabel>
                      <FormControl>
                        <div className="border-2 border-dashed border-white/20 rounded-xl p-8 text-center hover:border-primary/50 transition-colors cursor-pointer bg-white/5 relative group">
                          <Upload className="w-8 h-8 mx-auto mb-2 text-muted-foreground group-hover:text-primary transition-colors" />
                          <span className="text-sm text-muted-foreground font-rajdhani">Click to upload logo (PNG/JPG)</span>
                          <Input
                            {...fieldProps}
                            type="file"
                ...
                <GlassCard className="space-y-4">
                  {["name", "ign", "id", "email", "phone"].map((key) => (
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="capitalize text-primary/90 font-orbitron text-sm">{key === "id" ? "MLBB ID" : key === "ign" ? "In-Game Name" : key}</FormLabel>
                          <FormControl>
            ...
            <section>
              ...
              <div className="space-y-6">
                {[0, 1, 2, 3, 4].map((index) => (
                  <GlassCard key={index} className="border-l-4 border-l-primary/50 hover:border-l-primary transition-colors">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-10 h-10 rounded-full bg-primary/20 flex items-center justify-center font-orbitron font-bold text-primary border border-primary/30 shadow-[0_0_10px_rgba(6,182,212,0.3)]">
                        {index + 1}
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                          ...
                          <FormItem className="col-span-1 row-span-2 md:row-span-1 lg:row-span-1 flex justify-center items-center">
                             <FormControl>
                                <div className="relative group cursor-pointer">
                                  <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-primary/30 group-hover:border-primary transition-all shadow-[0_0_15px_rgba(6,182,212,0.2)] bg-black/40">
                                    {value ? (
                                      <img 
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-xs uppercase tracking-wider text-muted-foreground font-orbitron">Full Name</FormLabel>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-xs uppercase tracking-wider text-muted-foreground font-orbitron">IGN</FormLabel>
                            <FormControl><Input {...field} className="glass-input" /></FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-xs uppercase tracking-wider text-muted-foreground font-orbitron">MLBB ID</FormLabel>
                            <FormControl><Input {...field} className="glass-input" /></FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel className="text-xs uppercase tracking-wider text-muted-foreground font-orbitron">Role</FormLabel>
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                              <FormControl>
            ...
            <section className="mt-12">
               <div className="p-8 rounded-2xl border border-dashed border-primary/30 bg-primary/5 hover:bg-primary/10 transition-colors">
                  <FormField
                    control={form.control}
                    name="declaration"
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                        <FormControl>
                          <Checkbox
                            ...
                            className="border-primary data-[state=checked]:bg-primary data-[state=checked]:text-black w-6 h-6 mt-1"
                          />
                        </FormControl>
                        <div className="space-y-1 leading-none">
                          <FormLabel className="text-lg cursor-pointer font-rajdhani">
